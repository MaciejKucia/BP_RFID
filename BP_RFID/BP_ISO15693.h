...
#define ISO15693_FL1_Select_flag						(1<<4)
...
#define ISO15693_FL1_Address_flag						(1<<5)
...
#define ISO15693_FL1_Option_flag						(1<<6)
...
#define ISO15693_FL2_AFI_flag							(1<<4)

//b6 Nb_slots_flag
//0 16 slots
//1 1 slot
#define ISO15693_FL2_Nb_slots_flag						(1<<5)

//b7 Option_flag be set to 0 if not otherwise defined by the command.
//0 Meaning is defined by the command description. It shall be set to 0 if not otherwise defined by the command.
//1 Meaning is defined by the command description.
#define ISO15693_FL2_Option_flag						(1<<6)
